      ...
      <div class="lg:col-start-2 lg:col-end-7">
       <!--  <h3 class="font-inter mb-5 lg:mb-1 text-4xl lg:text-6xl font-semibold lg:leading-[66px]">
        ...
        <p>
          ...
          Die digitale Transformation aktiv vorantreiben und Unternehmen dabei
          unterstützen, sich modern und zukunftssicher aufzustellen.
          <br />
          <br />
          <span class="font-bold">Unser Service:</span> <br />
          Mit einem starken Fokus auf modernste Webtechnologien entwickeln wir
          maßgeschneiderte digitale Lösungen, die sowohl optisch begeistern als
          auch funktional überzeugen. Egal ob individuelle Webseiten,
          leistungsstarke Schnittstellen oder nahtlose Benutzererlebnisse – wir
          kombinieren Design und Entwicklung, um innovative und nachhaltige
          Ergebnisse zu erzielen.
          <br />
          <br />
          <!-- Wir setzen auf aktuelle Technologien, um Performance, Skalierbarkeit und Benutzerfreundlichkeit auf höchstem
          Niveau zu gewährleisten.  -->Gemeinsam gestalten wir Ihre digitale
          Zukunft – mit Leidenschaft, Präzision und einem klaren Blick.
        </p>
      </div>

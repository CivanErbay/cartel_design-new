<template>
  <div class="mt-6 text-sm">
    ...
    <p>Sömmeringstr. 73</p>
    <p>50825 Köln</p>
    <h4 class="font-semibold mt-3">Kontakt</h4>
    <p>hello@cartel-design.com</p>
    <p>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</p>
    <h4 class="font-semibold mt-3">Erbay & Muro Webdevelopment GbR</h4>
  </div>
  <div>
    <h5 class="font-semibold mt-6">EU-Streitschlichtung</h5>
    <p>
      Die Europäische Kommission stellt eine Plattform zur
      Online-Streitbeilegung (OS) bereit: https://ec.europa.eu/consumers/odr.
      Unsere E-Mail-Adresse finden Sie oben im Impressum.
    </p>
    <h5 class="font-semibold mt-6">Verbraucher­streit­beilegung/Universal­schlichtungs­stelle</h5>
    <p>
      Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor
      einer Verbraucherschlichtungsstelle teilzunehmen.
    </p>

    <h5 class="font-semibold mt-6">Haftung für Inhalte</h5>
    <p>
    ...
    <h5 class="font-semibold mt-6">Haftung für Links</h5>
    <p>
    ...
    <h5 class="font-semibold mt-6">Urheberrecht</h5>
    <p>
